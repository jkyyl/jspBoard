		...
		<div class="row">
			...
			<table width="100%">
		        ...
		        <tr>
		            <td>내용</td>
		            <td>
		                <textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;" value="${contentVo.content }"></textarea> 
		            </td>
		        </tr>
		        <tr>
		            <td>첨부파일</td>
<%-- 	            	<c:forEach items="${attachmentList}" var="attachmentList"> --%>
<%-- 	            		<label name="attachment" value="${attachmentList.fname }"/> --%>
<%-- 	            	</c:forEach> --%>
		            <td>
		                <input id="attach" class="hidden" type="file" name="file"/>
		                <input type="file" name="uploadfile" id="img" style="display:none;"/>
		                <input type="label" id="boardName" name="boardName" class="form" placeholder="첨부파일을 추가하세요" readonly>
		        ...
		        <tr>
			        <td>
				        <c:set value="${param.parentNo}" var="parentNo"></c:set>
